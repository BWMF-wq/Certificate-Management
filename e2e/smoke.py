...
with sync_playwright() as playwright:
    ...
    field(modal, "成果类型").select_option("LANGUAGE")
    field(modal, "荣誉级别").select_option("NATIONAL")
    ...
    page.get_by_role("button", name="证书数据概况", exact=True).click()
    page.wait_for_url("**/dashboard")
    page.wait_for_load_state("networkidle")
    page.get_by_text("大学英语六级证书").wait_for()
    ...
    page.get_by_role("heading", name="数据分析").wait_for()

...
with sync_playwright() as playwright:
    ...
    page.get_by_text("荣誉证书已移入回收站").wait_for()
    ...
    page.get_by_text("荣誉证书已永久删除").wait_for()
    page.get_by_text("回收站为空").wait_for()

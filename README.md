...
一套面向高校学生的个人荣誉证书管理 Web 应用。它把学习生涯中的学科竞赛、创新创业、文体活动、社会实践、志愿服务、荣誉称号及其他荣誉集中归档，并通过荣誉数据概况、荣誉证书管理、荣誉数据分析和回收站四个主要入口统一组织。

## 已实现功能

- 学号 / 邮箱注册登录，BCrypt 密码哈希与 JWT 无状态鉴权
- 登录前明确确认荣誉证书记录与真实性责任条款及平台免责边界，禁止将记录用于虚假营销、欺骗或隐瞒
- 学生之间的数据完全隔离，个人资料维护
- 荣誉证书新增、编辑、分页、关键词搜索、荣誉类型 / 荣誉级别 / 奖项分类筛选和多种排序
- 删除证书后先移入回收站并保留附件，支持恢复与永久删除
- 荣誉类型统一为学科竞赛、创新创业、文体活动、社会实践、志愿服务、荣誉称号和其他荣誉
- 荣誉级别统一为国家级荣誉、省市级荣誉、区县级荣誉、校级荣誉和其他荣誉
- 奖项分类统一为个人奖、团体奖和单位奖；有效期仅作为少数荣誉证书的可选档案字段，不提供到期提醒
- PDF、JPG、PNG、WebP 附件上传、替换、下载和删除（单文件最大 10MB）
- 荣誉证书总量、本年度新增、电子附件覆盖、颁发机构、荣誉类型、荣誉级别、奖项构成和近 12 个月趋势统计
- 桌面端与移动端响应式界面，支持荣誉证书网格 / 列表显示切换
...
集成测试覆盖注册、未授权拦截、荣誉证书创建、搜索与分类筛选、奖项分类、荣誉级别、数据概况统计、软删除、回收站查询、恢复和永久删除流程。
...
│     └─ views/                     登录、注册、荣誉概览、荣誉证书、回收站和账户页面
├─ deploy/

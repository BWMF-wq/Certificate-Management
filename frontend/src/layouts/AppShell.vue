...
@media (max-width: 860px) {
  ...
  .main-area,.nav-collapsed .main-area { margin-left: 0; }.nav-scrim { display: block; position: fixed; inset: 0; background: rgba(14,30,43,.45); z-index: 90; backdrop-filter: blur(3px); }

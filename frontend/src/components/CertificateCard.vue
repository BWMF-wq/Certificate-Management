...
.cat-academic-education{--accent:#315c82}.cat-language-exam{--accent:#2f7d78}.cat-professional-qualification{--accent:#a84b3e}.cat-skill-certification{--accent:#8b6f35}.cat-competition-award{--accent:#c9503d}.cat-innovation-entrepreneurship{--accent:#b27935}.cat-training-certificate{--accent:#4f718e}.cat-culture-sports{--accent:#735f91}.cat-social-practice{--accent:#397f9b}.cat-volunteer-service{--accent:#2f7d78}.cat-honorary-title{--accent:#b89431}.cat-intellectual-property{--accent:#6b5a8b}.cat-other{--accent:#687a88}
